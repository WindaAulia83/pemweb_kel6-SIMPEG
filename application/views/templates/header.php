...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - My Profile -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('profilperusahaan/my_profile');?>">
            ...
            <!-- Nav Item - Riwayat Kerja -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url();?>riwayatkerja">
                    <i class="fas fa-fw fa-briefcase"></i>
                    <span>Riwayat Kerja</span></a>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                src="<?= base_url('assets/img/profile/default.jpg' . $this->session->userdata('image')); ?>" alt="User Profile">
                            </a>
