    ...
    <div class="row mt-3">
        ...
        <div class="card">
            <div class="card-header">
                Form Ubah Riwayat Kerja
            </div>
            <div class="card-body">
                <form action="" method="post">
                    <input type="hidden" name="id_pegawai" value="<?= $riwayatkerja['id_pegawai'];?>">
                    <div class="form-group">
                        <label for="nama">Nama</label>
                        <input type="text" name="nama" class="form-control" id="nama" value="<?= $riwayatkerja['nama'];?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="riwayat_pengalaman" class="form-control" id="riwayat_pengalaman"value="<?= $riwayatkerja['riwayat_pengalaman'];?>">
